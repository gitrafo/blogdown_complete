...
The message for me is not to take the internal tagging logic of Samsung´s app seriously. I will re-run the script once collect more data - that´s cool about scripting:)
